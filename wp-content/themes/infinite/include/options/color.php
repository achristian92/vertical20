	...
	*/	
		...
		function infinite_gdlr_core_skin_options( $options = array() ){
			...
			$options = array_merge($options, array(
				...
				'carousel-bullet-background' => array(
					'title' => esc_html__('Carousel Bullet Background', 'infinite'),
				...
				'carousel-bullet-active-background' => array(
					'title' => esc_html__('Carousel Bullet Active Background', 'infinite'),
	...
	$infinite_admin_option->add_element(apply_filters('infinite_color_options',array(
		...
		'options' => array(
				...
				'options' => array(
					...
					'page-caption-color' => array(
						...
						'selector' => '.infinite-page-title-wrap .infinite-page-caption{ color: #gdlr#; }' .
							...
							'.infinite-page-title-wrap .infinite-page-title-event-time, ' . 
							'.infinite-page-title-wrap .infinite-page-title-event-link a, .infinite-page-title-wrap .infinite-page-title-event-link a:hover{ color: #gdlr#; }'
					),
					'page-title-background-color' => array(
						'title' => esc_html__('Page Title Background Overlay Color', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#000000',
						'selector' => '.infinite-page-title-wrap{ background-color: #gdlr#; }'
					),
					...
					'link-color' => array(
						...
						'selector' => '.infinite-body a{ color: #gdlr#; }'  . 
							'.infinite-blog-style-3 .infinite-comments-area .comment-reply a, .infinite-blog-style-3 .infinite-comments-area .comment-reply a:hover{ color: #gdlr#; }' .
					...
					'input-box-background-color' => array(
						...
						'selector' => '.infinite-body input, ' .  
							'.infinite-body textarea, .infinite-body select, .woocommerce form .select2-selection{ background-color: #gdlr#; }'
					),
					'input-box-border-color' => array(
						...
						'default' => '#d7d7d7',
						'selector' => '.infinite-body input, ' .  
							'.infinite-body textarea, .infinite-body select, .woocommerce form .select2-selection{ border-color: #gdlr#; }'
					),
					'input-box-text-color' => array(
						...
						'default' => '#4e4e4e',
						'selector' => '.infinite-body input, ' .  
							'.infinite-body textarea, .infinite-body select, .woocommerce form .select2-selection{ color: #gdlr#; }'
					),
			...
			'sidebar-color' => array(
				...
				'options' => array(	
					...
					'custom-menu-widget-box-style-text' => array(
						'title' => esc_html__('Custom Menu Widget Box Style Text', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#474747',
					...
					'custom-menu-widget-box-style-background' => array(
						'title' => esc_html__('Custom Menu Widget Box Style Background', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#f3f3f3',
						'selector' => 'ul.gdlr-core-custom-menu-widget.gdlr-core-menu-style-box li a, ' . 
					...
					'custom-menu-widget-box-style-text-active' => array(
						'title' => esc_html__('Custom Menu Widget Box Style Text Active', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
					...
					'custom-menu-widget-box-style-background-active' => array(
						'title' => esc_html__('Custom Menu Widget Box Style Background Active', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#143369',
						'selector' => 'ul.gdlr-core-custom-menu-widget.gdlr-core-menu-style-box li a:hover, ' . 
							'ul.gdlr-core-custom-menu-widget.gdlr-core-menu-style-box li.current-menu-item a, ' . 
			...
			'single-blog' => array(
				...
				'options' => array(		
					...
					'single-blog-navigation-color' => array(
						...
						'type' => 'colorpicker',
						'default' => '#bcbcbc',
						'selector' => '.infinite-single-nav a, .infinite-single-nav a:hover, .infinite-blog-style-3 .infinite-single-nav .infinite-text{ color: #gdlr#; }'
					),
					...
					'single-blog-comment-title-color' => array(
						...
						'type' => 'colorpicker',
						'default' => '#464646',
						'selector' => '.infinite-comments-area .infinite-comments-title, ' . 
							'.infinite-comments-area .comment-reply-title, .infinite-single-related-post-wrap .infinite-single-related-post-title{ color: #gdlr#; }'
					),
			...
			'blog-color' => array(
				...
				'options' => array(
					...
					'blog-thumbnail-date-background' => array(
						'title' => esc_html__('Blog Thumbnail Date Background Color', 'infinite'),
						'type' => 'colorpicker',
						'data-type' => 'rgba',
						'default' => '#efefef',
						'selector' => '.gdlr-core-blog-full.gdlr-core-style-2-date .gdlr-core-blog-info-date,' . 
							'.gdlr-core-blog-grid.gdlr-core-style-2-date .gdlr-core-blog-info-date{ background-color: #gdlr#; }'
					),
					'blog-thumbnail-date-text' => array(
						'title' => esc_html__('Blog Thumbnail Date Text Color', 'infinite'),
						'type' => 'colorpicker',
						'data-type' => 'rgba',
						'default' => '#3dbca8',
						'selector' => '.gdlr-core-blog-full.gdlr-core-style-2-date .gdlr-core-blog-info-date a,' .
							'.gdlr-core-blog-grid.gdlr-core-style-2-date .gdlr-core-blog-info-date a{ color: #gdlr#; }'
					),
					...
					'blog-aside-text-color' => array(
						...
						'selector' => '.infinite-blog-aside-format .infinite-single-article-content, ' . 
							...
							'.infinite-blog-quote-format .infinite-single-article-content blockquote a, ' . 
			...
			'event-color' => array(
				'title' => esc_html__('Event Color', 'infinite'),
				'options' => array(
					'event-item-date-color' => array(
						'title' => esc_html__('Event Item Date Color', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#50bd77',
					...
					'event-item-title-color' => array(
						'title' => esc_html__('Event Item Title Color', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#182847',
					...
					'event-item-info-color' => array(
						'title' => esc_html__('Event Item Info Color', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#50bd77',
			...
			'port-color' => array(
				...
				'options' => array(
					...
					'single-portfolio-nav-icon' => array(
						'title' => esc_html__('Single Portfolio Navigation Icon (Style 2)', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#4275dc',
					...
					'single-portfolio-nav-background' => array(
						'title' => esc_html__('Single Portfolio Navigation Background (Style 2)', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#f3f3f3',
					...
					'portfolio-medium-feature-content-bg-color' => array(
						'title' => esc_html__('Portfolio Medium Feature Content Background Color', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#2653e3',
					...
					'portfolio-medium-feature-title-color' => array(
						'title' => esc_html__('Portfolio Medium Feature Title Color', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
					...
					'portfolio-medium-feature-tag-color' => array(
						'title' => esc_html__('Portfolio Medium Feature Tag Color', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#abbfff',
			...
			'element-2-color' => array(
				...
				'options' => array(
					...
					'button-text-hover-color' => array(
						...
						'type' => 'colorpicker',
						'default' => '#ffffff',
						'selector' => '.gdlr-core-body .gdlr-core-load-more:hover, .gdlr-core-body .gdlr-core-button:hover, .infinite-body .infinite-button:hover{ color: #gdlr#; }'
					),
					'button-background-color' => array(
						...
						'selector' => '.gdlr-core-body .gdlr-core-load-more, .gdlr-core-body .gdlr-core-button, .infinite-body .infinite-button, ' .
							...
							'.infinite-blog-style-4 .infinite-comments-area .form-submit input[type="submit"]{ box-shadow: 5px 5px 20px rgba(#gdlra#, 0.4); -webkit-box-shadow: 5px 5px 20px rgba(#gdlra#, 0.4); -moz-box-shadow: 5px 5px 20px rgba(#gdlra#, 0.4); }'
					),
			...
			'element-4-color' => array(
				...
				'options' => array(
					...
					'custom-slider-navigation-color' => array(
						'title' => esc_html__('Custom Slider Navigation Color', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#a7a7a7',
						'selector' => '.gdlr-core-flexslider-custom-nav i{ color: #gdlr#; }'
					),
					'custom-slider-navigation-hover-color' => array(
						'title' => esc_html__('Custom Slider Navigation Hover Color', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#a7a7a7',
					...
					'slider-control-navigation-background-color' => array(
						'title' => esc_html__('Slider Bullet Background Color', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#dfdfdf',
					...
					'testimonial-frame-background-color' => array(
						'title' => esc_html__('Testimonial Frame Background Color', 'infinite'),
						'type' => 'colorpicker',
						'default' => '#ffffff',
				...
				'options' => array(
					...
					'woocommerce-price-color' => array(
						...
						'selector' => 'span.woocommerce-Price-amount.amount{ color: #gdlr#; }' .
							'.infinite-top-cart-content-wrap .infinite-highlight, .infinite-top-cart-item-wrap .infinite-top-cart-price-wrap .woocommerce-Price-amount.amount{ color: #gdlr#; }'
					),
